const handleRegistration = (event) => {
    ...
    if (password === confirm_password) {
        ...
        fetch("https://excileence-academy-api-5v91.onrender.com/user/register/", {
            method: "POST",
...
const handleLogin = (event) =>{
    ...
    if ((username,password)){
        fetch("https://excileence-academy-api-5v91.onrender.com/user/login/",{
        ...
        .then((data) =>{
            ...
            if(data.token && data.user_id){
                ...
                fetch(`https://excileence-academy-api-5v91.onrender.com/user/list/?user_id=${data.user_id}`)
...
const getTeacher = () => {
    ...
    fetch(`https://excileence-academy-api-5v91.onrender.com/user/list/?user_id=${user_id}`)
...
const change_password = (event) =>{
    ...
    if (new_password !== confirm_password) {
        ...
        fetch("https://excileence-academy-api-5v91.onrender.com/user/change-password/",{
...
const handlelogout = (event)=>{
    ...
    fetch("https://excileence-academy-api-5v91.onrender.com/user/logout/",{
