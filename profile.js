const handleUserProfile = () =>{
    ...
    fetch(`https://excileence-academy-api-5v91.onrender.com/user/data/${user_id}`)
...
const changeImage = (event)=>{
    ...
    if (!image_check){
        ...
        link_onrender = `https://excileence-academy-api-5v91.onrender.com/user/image/post/${user_id}`
    }
    else{
        method = "PUT"
        
        link_onrender = `https://excileence-academy-api-5v91.onrender.com/user/image/${user_id}`
    }
    console.log(method)
